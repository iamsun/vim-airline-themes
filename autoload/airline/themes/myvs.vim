...
function! airline#themes#myvs#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background  = get(g:, 'airline_myvs_bg', &background)
  let s:ansi_colors = get(g:, 'myvs_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:tty         = &t_Co == 8
  ...
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Base colors
  let s:base03  = {'t': s:ansi_colors ?   8 : (s:tty ? '0' : 234), 'g': '#1f1f1f'}
  let s:base02  = {'t': s:ansi_colors ? '0' : (s:tty ? '0' : 235), 'g': '#292929'}
  let s:base01  = {'t': s:ansi_colors ?  10 : (s:tty ? '0' : 240), 'g': '#686868'}
  let s:base00  = {'t': s:ansi_colors ?  11 : (s:tty ? '7' : 241), 'g': '#757575'}
  let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '7' : 244), 'g': '#8f8f8f'}
  let s:base1   = {'t': s:ansi_colors ?  14 : (s:tty ? '7' : 245), 'g': '#c6c6c6'}
  let s:base2   = {'t': s:ansi_colors ?   7 : (s:tty ? '7' : 254), 'g': '#e7e7e7'}
  let s:base3   = {'t': s:ansi_colors ?  15 : (s:tty ? '7' : 230), 'g': '#f5f5f5'}
  ...
  let s:blue    = {'t': s:ansi_colors ?   4 : (s:tty ? '4' : 33 ), 'g': '#4271ae'}
  ...
  let g:airline#themes#myvs#palette.accents = {
        \ 'red': s:NFa,
        \ }
  ...
  let g:airline#themes#myvs#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#myvs#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#myvs#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#myvs#palette.normal_modified.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#myvs#palette.insert.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#myvs#palette.insert_modified.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#myvs#palette.visual.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#myvs#palette.visual_modified.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#myvs#palette.replace.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#myvs#palette.replace_modified.airline_warning =
        \ g:airline#themes#myvs#palette.normal.airline_warning

  let g:airline#themes#myvs#palette.tabline = {}

  let g:airline#themes#myvs#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#myvs#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#myvs#refresh()
